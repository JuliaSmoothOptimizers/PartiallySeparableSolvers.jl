...
function update_BFGS!(
  Δx::AbstractVector{Y}, #difference between to points
...
function update_BFGS!(
  x::AbstractVector{Y},
  x_1::AbstractVector{Y},
  g::AbstractVector{Y},
  g_1::AbstractVector{Y},
  B::AbstractArray{Y, 2},
  B_1::AbstractArray{Y, 2},
) where {Y <: Number}
...
"""
function update_SPS_mix_SR1_BFGS!(
  sps::PartiallySeparableNLPModels.SPS{T},
  B::PartiallySeparableNLPModels.Hess_matrix{Y},
  B_1::PartiallySeparableNLPModels.Hess_matrix{Y},
  y::PartiallySeparableNLPModels.grad_vector{Y},
